...
const HERO_SLIDES = [
  { title: "Healing Crystals", sub: "Dil aur dimag ko shanti dein", bg: "https://images.unsplash.com/photo-1518568814500-bf0f8d125f46?w=600" },
  { title: "Protection Malas", sub: "Negative energy se bachein", bg: "https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=600" },
  { title: "Spiritual Pujas", sub: "Ghar mein sukh-shanti laayein", bg: "https://images.unsplash.com/photo-1604881988758-f76ad2f7aac1?w=600" },
];
      ...
      <div style={{ padding: "0 0 80px" }}>
        ...
        <div style={{ position: "relative", height: 160, overflow: "hidden" }}>
          {HERO_SLIDES.map((slide, i) => (
            <div key={i} style={{
              position: "absolute", inset: 0, opacity: currentSlide === i ? 1 : 0, transition: "opacity 0.5s ease",
              backgroundImage: `linear-gradient(rgba(0,0,0,0.45), rgba(0,0,0,0.55)), url(${slide.bg})`,
              backgroundSize: "cover", backgroundPosition: "center", display: "flex", flexDirection: "column", justifyContent: "center", padding: "0 20px",
            }}>
        ...
        <div style={{ padding: "12px 14px" }}>
          <div style={{ background: "linear-gradient(135deg, #FFF8F2, #FFF3E0)", border: "1px solid #FFCC80", borderRadius: 12, padding: 12 }}>
            <div style={{ fontSize: 12, fontWeight: 700, color: "#FF6B00", marginBottom: 8 }}>🎯 Kisliye remedy chahiye?</div>
            <input
              type="text" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)}
              placeholder="breakup, naukri, tension..."
              style={{ width: "100%", background: "#fff", border: "1px solid #FFE0B2", borderRadius: 8, padding: "10px 12px", fontSize: 13, outline: "none", color: "#333", boxSizing: "border-box" }}
            />
          </div>
        </div>

        {/* Category grid - 2 per row, 140px height, darker gradient */}
          ...
          {filteredCategories.map((cat) => (
            <div
              ...
              style={{
                ...
                backgroundImage: `linear-gradient(rgba(0,0,0,0.25), rgba(0,0,0,0.65)), url(${cat.image})`,
