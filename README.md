...
[![GitHub](https://img.shields.io/badge/Repo-astha--ai-black?style=for-the-badge&logo=github)](https://github.com/sanjeetbuilds/astha-ai)

---

## Why This Exists

I opened an astrology app as a real user — not to audit it, but with an actual problem in mind.
...
The supply was good. Astrologers existed. Products existed.  
...
| **5th exam attempt** | UPSC, SSC, state exams — all failed. Family ne sab kuch daanv par lagaya. Looking for any signal that things will turn. |
| **Shaadi delayed 3 years** | Parents asking daily. Extended family watching. The pressure has a specific weight. |
| **Business in loss** | Was doing okay. Then wasn't. Looking for timing, clarity, some explanation. |
...
> These people don't search like ecommerce users. They know what they're **feeling** — not what to search for.
...
```
"Mera ex wapas nahi aa raha"   →   Love & Relationship
...
## The AstroTalk Version

A separate prototype was built for AstroTalk — a more advanced platform with a different, subtler problem.

AstroTalk has category chips. Filtering works. But tap **Career** and every astrologer card still says `"Vedic, AI Astrologer"`.

> **The chip captured the intent. The card forgot it.**

Someone who just told the app they need career help is now looking at three identical strangers with no signal on which one has helped someone like them.

That prototype shows what it looks like when context doesn't disappear — when the chip selection flows into the card, into the profile, into the store.

➡️ [github.com/sanjeetbuilds/astrotalk-intent](https://github.com/sanjeetbuilds/astrotalk-intent)
